...
// ─────────────────────────────────────────────────────────────────────────────
// FIAT PULSE ABARTH 2026  —  versión deportiva
// ─────────────────────────────────────────────────────────────────────────────

const PULSE_ABARTH: Categoria[] = [
  {
    id: 'desempeno', nombre: 'Desempeño', specs: [
      { label: 'Motor',                    valor: '1.3 L Turbo' },
      { label: 'Potencia',                 valor: '173 hp @ 5,750 rpm' },
      { label: 'Torque',                   valor: '198 lb-pie @ 1,850 rpm' },
      { label: 'Aceleración 0-100 km/h',   valor: '8 s' },
      { label: 'Transmisión',              valor: 'Automática 6 velocidades' },
      { label: 'Modos de manejo',          valor: 'Normal, Sport y Poison (botón en volante)' },
      { label: 'Paletas de cambio',        valor: 'Al volante' },
      { label: 'Encendido desde llave',    valor: 'Sí' },
      { label: 'Tanque de combustible',    valor: '48 L' },
      { label: 'Tracción',                 valor: 'Delantera' },
      ...
      { label: 'Suspensión delantera',     valor: 'McPherson con ruedas independientes, brazos basculantes con barra estabilizadora' },
      { label: 'Suspensión trasera',       valor: 'Eje de torsión con ruedas semi-independientes' },
      { label: 'Consumo ciudad',           valor: '14.21 km/L' },
      { label: 'Consumo carretera',        valor: '19.86 km/L' },
      { label: 'Consumo combinado',        valor: '16.29 km/L' },
    ],
  },
  {
    id: 'exterior', nombre: 'Exterior', specs: [
      ...
      { label: 'Luces diurnas (DRL)',              valor: 'LED' },
      { label: 'Luces traseras',                   valor: 'LED' },
      { label: 'Faros de niebla',                  valor: 'LED con función cornering (NUEVOS)' },
      { label: 'Encendido automático de luces',    valor: 'Sí' },
      { label: 'Espejos laterales',                valor: 'Ajuste eléctrico, direccionales LED, abatibles eléctricos, luz de cortesía' },
      { label: 'Parrilla',                         valor: 'Abarth con logo, insertos contrastantes y nuevo diseño' },
      { label: 'Fascia delantera',                 valor: 'Nuevo diseño bodycolor con inserto negro' },
      { label: 'Emblemas exteriores',              valor: 'ABARTH' },
      { label: 'Insertos laterales',               valor: 'Negro' },
      { label: 'Manijas exteriores',               valor: 'Al color de la carrocería' },
      { label: 'Techo panorámico',                 valor: 'Con cortina eléctrica' },
      { label: 'Escape',                           valor: 'Deportivo de doble salida' },
      { label: 'Spoiler trasero',                  valor: 'Sí' },
      { label: 'Techo bitono',                     valor: 'Sí (negro)' },
      { label: 'Limpiaparabrisas trasero',         valor: 'Sí' },
      { label: 'Sensor de temperatura externa',    valor: 'Sí' },
      { label: 'Rines',                            valor: 'Aluminio pintado negro 18" (diseño nuevo)' },
      { label: 'Neumáticos',                       valor: '215/45 R18' },
      { label: 'Llanta de refacción',              valor: 'Compacta' },
      { label: 'Longitud',                         valor: '4,129 mm' },
      { label: 'Ancho sin espejos',                valor: '1,777 mm' },
      { label: 'Altura',                           valor: '1,546 mm' },
      { label: 'Distancia entre ejes',             valor: '2,532 mm' },
      { label: 'Diámetro de giro',                 valor: '10.5 m' },
      { label: 'Capacidad de cajuela',             valor: '370 L' },
      { label: 'Colores disponibles',              valor: 'Negro Vulcano; Rojo Montecarlo / Gris Strato / Blanco Banchisa (con techo negro)' },
    ],
  },
  {
    id: 'interior', nombre: 'Interior', specs: [
      { label: 'A/C',                              valor: 'Automático con control eléctrico y filtro antipolen' },
      { label: 'Tapicería',                        valor: 'Piel con diseño ABARTH' },
      { label: 'Asientos deportivos',              valor: 'Sí' },
      { label: 'Ajuste longitudinal asientos',     valor: 'Eléctrico conductor 6 vías (NUEVO)' },
      { label: 'Asiento conductor',                valor: 'Con ajuste de altura' },
      { label: 'Asiento trasero',                  valor: 'Abatible 60/40' },
      { label: 'Cajuela iluminada',                valor: 'Sí' },
      { label: 'Cristales eléctricos',             valor: 'Delanteros y traseros con anti-pellizco' },
      ...
      { label: 'Desempañador trasero',             valor: 'Con temporizador' },
      { label: 'Espejo retrovisor',                valor: 'Electrocrómico' },
      { label: 'Salida ventilación 2ª fila',       valor: 'Sí' },
      { label: 'Seguros eléctricos',               valor: 'Sensibles a la velocidad (20 km/h)' },
      { label: 'Audio',                            valor: '4 bocinas + 2 tweeters' },
      { label: 'Viseras con espejo vanidad',       valor: 'Iluminadas' },
      { label: 'Volante',                          valor: 'Ajuste altura y profundidad, forrado en piel' },
    ],
  },
  {
    id: 'tecnologia', nombre: 'Tecnología y Entretenimiento', specs: [
      ...
      { label: 'Radio',                            valor: 'AM/FM + USB + AUX + voz + streaming' },
      { label: 'Cámara de reversa',                valor: 'HD con ParkView® líneas activas' },
      { label: 'Tilt down retrovisores en reversa',valor: 'Sí' },
    ],
  },
  {
    id: 'seguridad', nombre: 'Seguridad', specs: [
...
export const MODELOS_FIAT: ModeloFicha[] = [
  ...
  {
    id: 'fiat-pulse-abarth-2026',
    marca: 'Fiat',
    modelo: 'Pulse Abarth',
    año: 2026,
    versiones: [
      { id: 'abarth', nombre: 'Abarth', categorias: PULSE_ABARTH },
    ],
  },
  {
