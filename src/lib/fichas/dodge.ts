...
const JOURNEY_SXT: Categoria[] = [
  ...
  },
  {
    id: 'exterior', nombre: 'Exterior', specs: [
      { label: 'Faros delanteros',           valor: 'LED' },
      { label: 'Faros de niebla',            valor: 'LED' },
      { label: 'DRL',                        valor: 'LED' },
      { label: 'Luces traseras',             valor: 'LED' },
      { label: 'Alerón trasero con luz LED', valor: 'Sí' },
      { label: 'Espejos laterales',          valor: 'Eléctricos ajustables con luz direccional' },
      ...
      { label: 'Sensor de lluvia/luz',       valor: 'No incluido' },
    ],
  },
  {
  ...
  },
  {
    id: 'tecnologia', nombre: 'Tecnología y Entretenimiento', specs: [
      ...
      { label: 'Cargador tel. inalámbrico',  valor: 'Sí' },
      { label: 'Cierre express',             valor: 'No incluido' },
      { label: 'Modo Sport',                 valor: 'Sí' },
  ...
  },
  {
    id: 'seguridad', nombre: 'Seguridad', specs: [
      ...
      { label: 'Descenso de pendientes (HDC)',           valor: 'Sí' },
      ...
      { label: 'Cinturones 2ª fila con pretensores',    valor: 'Sí' },
